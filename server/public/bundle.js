...
var apiEndPoint = 'https://haveibeenpwned.com/api/v2/breachedaccount/';

function getEmail(email) {
  return _superagent2.default.get(apiEndPoint + email).set('User-Agent', 'Firefox').then(function (res) {
    return res.body;
  });
}
...
var _index = __webpack_require__(/*! ../api/index */ "./client/api/index.js");
...
var SubmitForm = function (_React$Component) {
  ...
  _createClass(SubmitForm, [{
    ...
    value: function clickHandle() {
      ...
      return (0, _index.getEmail)(this.state.breach).then(function (res) {
        return _this2.setState({ breach: res });
      });
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'label',
            null,
            _react2.default.createElement('input', { type: 'text', email: 'text', onChange: this.handleChange })
          ),
          _react2.default.createElement(
            'button',
        ...
        _react2.default.createElement(
          'ul',
          null,
          this.state.breach.map(function (obj) {
            return obj.Domain;
          })
        )
      );
